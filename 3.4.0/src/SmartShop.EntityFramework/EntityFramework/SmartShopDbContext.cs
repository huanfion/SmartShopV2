...
{
    public class SmartShopDbContext : AbpDbContext
    {
        ...
        public virtual IDbSet<HTAdmin> HTAdmins { get; set; }
        public virtual IDbSet<HTAdminSafety> HTAdminSafetys { get; set; }
        public virtual IDbSet<HTApplicationNode> HTApplicationNodes { get; set; }
        public virtual IDbSet<HTGroup> HTGroups { get; set; }
        public virtual IDbSet<HTPermissionInAdmin> HTPermissionInAdmins { get; set; }
        public virtual IDbSet<HTPermissionInGroup> HTPermissionInGroups { get; set; }
        public virtual IDbSet<HTPermissionInRole> HTPermissionInRoles { get; set; }
        public virtual IDbSet<HTPermission> HTPermissions { get; set; }
        public virtual IDbSet<HTRoleInGroup> HTRoleInGroups { get; set; }
        public virtual IDbSet<HTRole> HTRoles { get; set; }
        ...
        public virtual IDbSet<HTUser> HTUsers { get; set; }
        /* NOTE: 
